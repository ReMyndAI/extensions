...
Note: after making any file-level changes to your extension (e.g. updating the manifest), click the Refresh button in the bottom-left corner of the Extension Manager to reflect the changes.
